...
package org.apache.cassandra.utils.checksum;
...
/**
 * NOTE: THIS IS A COMPLETE COPY OF Java 9's CRC32C class. It is copied to
 * run a microbenchmark on Java 8 to see how the native implementation behaves.
 * Summary of custom changes:
 * - changed Unsafe import package from jdk.internal.misc to sun.misc
 * - removed @HotSpotIntrinsicCandidate annotation
 *
 * ===========================================================================
 ...
 * @since 9
 */
public final class Java9PortForCRC32C implements Checksum {
